...
GitHub Release, decrypts the Apple signing payload at the process boundary,
signs and notarizes the macOS binaries, signs and attests all artifacts, and
updates the Homebrew tap. See [Releases](docs/RELEASES.md) for the complete
